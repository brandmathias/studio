...
const MOCK_CUSTOMERS_RAW: Omit<Customer, 'upc' | 'segment' | 'priority' | 'follow_up_status'>[] = [
  {
    id: '1178724010014909',
  ...
  return (
    <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
      ...
      <div className="flex items-center">
        <h1 className="text-2xl font-bold tracking-tight font-headline">Analisis Nasabah</h1>
      </div>
